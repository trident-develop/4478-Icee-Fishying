...
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.core.DeviceMotion
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.network.SimInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.network.VpnInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.network.ProxyInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.network.WifiInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.network.TimezoneInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.sensor.GyroscopeInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.sensor.AccelerometerInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.sensor.LightSensorInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.sensor.AudioVolumeInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.sensor.MagnetometerInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.sensor.ProximitySensorInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.WidevineInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.CpuInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.BuildInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.BatteryInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.UptimeInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.BrightnessInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.InstallSourceInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.AccessibilityInfo
import photo.editor.photoeditor.filtersforpictu.model.gray4.device_props.system.RootInfo
...
class DevicePropertiesResult private constructor(
    ...
    companion object {
         ...
         * - не забудьте замінити "photo.editor.photoeditor.filtersforpictu.model.gray4.device_props" пакедж на свій
